...
#define ROTARY_ENCODER_BUTTON_PIN 16 //空置，无效
...
void rotary_loop()
{
  ...
  if (rotaryEncoder.encoderChanged())
  {
   // Serial.print("Value: ");
    ...
    light = rotaryEncoder.readEncoder();
  }
...
void setup()
{
  ...
  pinMode(34,INPUT);
  attachInterrupt(digitalPinToInterrupt(34), FUN1, RISING);
  pinMode(35,INPUT);
  attachInterrupt(digitalPinToInterrupt(35), FUN2, RISING);
