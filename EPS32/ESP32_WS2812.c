...
const char *ssid = "*****";
  const char *password = "*****";
const char *ssid_ = "wei xing ban ban gong shi";
const char *password_ = "weixing1234+-*/";
#define LED_NUM 320
...
//中断函数
int lightflag = 1;
ICACHE_RAM_ATTR void FUN34()
{
  Serial.println("Press GPIO 34");
...
ICACHE_RAM_ATTR void FUN35()
{
  Serial.println("Press GPIO 35");
}
ICACHE_RAM_ATTR void FUN36()
{
  Serial.println("Press GPIO 36");
}
ICACHE_RAM_ATTR void FUN39()
{
  Serial.println("Press GPIO 39");
}
//主函数
void setup()
{
  ...
  // pinMode(36,INPUT);
  // pinMode(39,INPUT);
  //attachInterrupt(digitalPinToInterrupt(34), FUN34, RISING);
  //attachInterrupt(digitalPinToInterrupt(35), FUN35, RISING);
  // attachInterrupt(digitalPinToInterrupt(36),FUN36,RISING);
  // attachInterrupt(digitalPinToInterrupt(39),FUN39,RISING);
  WS.begin(); // WS2812驱动使能
  Serial.begin(9600);
  if (digitalRead(36)) {
