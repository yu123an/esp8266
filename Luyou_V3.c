...
#include <PubSubClient.h>
  #define AIO_SERVER "**************z"
  #define AIO_SERVERPORT 1************** // use 8883 for SSL
...
void loop()
{
  ...
  MQTT_connect();
    ...
    Get_Mqtt(3);
    delay(998);
      if ((_hour * 60 + _minute > Sun_rise_hour * 60 + Sun_rise_minute) && (_hour* 60 + _minute < Sun_set_hour * 60 + Sun_set_minute))
  {
Serial.println("Now is day !!!");
  }else{Serial.println("Now is night !!!");}
}
